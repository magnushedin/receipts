...
def button_show_add_window_click(db, lb_items, lbl_sum):
    ...
    label_info =       tk.Label(window_add, text=itm.sum, font=('Courier New', 50))
    ...
    btn_zero =  tk.Button(window_add, text="0", font=('Courier New', 50), command=lambda:button_number_click(0, itm, label_info))
    btn_one =   tk.Button(window_add, text="1", font=('Courier New', 50), command=lambda:button_number_click(1, itm, label_info))
    btn_two =   tk.Button(window_add, text="2", font=('Courier New', 50), command=lambda:button_number_click(2, itm, label_info))
    btn_three = tk.Button(window_add, text="3", font=('Courier New', 50), command=lambda:button_number_click(3, itm, label_info))
    btn_four =  tk.Button(window_add, text="4", font=('Courier New', 50), command=lambda:button_number_click(4, itm, label_info))
    btn_five =  tk.Button(window_add, text="5", font=('Courier New', 50), command=lambda:button_number_click(5, itm, label_info))
    btn_six =   tk.Button(window_add, text="6", font=('Courier New', 50), command=lambda:button_number_click(6, itm, label_info))
    btn_seven = tk.Button(window_add, text="7", font=('Courier New', 50), command=lambda:button_number_click(7, itm, label_info))
    btn_eight = tk.Button(window_add, text="8", font=('Courier New', 50), command=lambda:button_number_click(8, itm, label_info))
    btn_nine =  tk.Button(window_add, text="9", font=('Courier New', 50), command=lambda:button_number_click(9, itm, label_info))
    btn_comma =  tk.Button(window_add, text=",", font=('Courier New', 50), command=lambda:button_comma_click(itm, label_info))
    btn_del =  tk.Button(window_add, text="<-", font=('Courier New', 50), command=lambda:button_delete_click(itm, label_info))
